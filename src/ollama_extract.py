...
def test_ollama():
    ...
    def send_image_to_ollama(image_path):
        ...
        with open("config/question.txt", 'r') as f:
            question = f.read() 
        ...
        data = {
            ...
            "messages": [
                {
                    "role": "user",
                    "content": f""" You are a helpful assistant that responds in JSON format with the invoice information in English or Vietnamese. 
                                Don't add any annotations there. Remember to close any bracket. Only return json result, don't return irrelevent infomation.
                                Question: {question}
                            """,
